...
var questions = [
    ...
    new Question(document.getElementById("magic").innerHTML = "<img src='level10.png'>", ["1", "8","10", "4"], "1"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level11.png'>", ["2", "6","5", "7"], "5"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level12.png'>", ["3", "8","5", "4"], "5"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level13.png'>", ["2", "9","10", "4"], "9"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level14.png'>", ["1", "8","2", "4"], "1"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level15.png'>", ["2", "1","6", "4"], "2"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level16.png'>", ["6", "9","1", "4"], "1"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level17.png'>", ["2", "8","6", "4"], "4"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level18.png'>", ["1", "8","7", "5"], "8"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level19.png'>", ["9", "6","2", "7"], "7"),
	new Question(document.getElementById("magic").innerHTML = "<img src='level20.png'>", ["3", "4","2", "8"], "2"),
];
